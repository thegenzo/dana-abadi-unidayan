        ...
        <div class="card bg-light-info shadow-none position-relative overflow-hidden">
            <div class="card-body px-4 py-3">
                <div class="row align-items-center">
                    <div class="col-9">
                        <h4 class="fw-semibold mb-8">Data Unit Kerja</h4>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a class="text-muted" href="{{ route('admin-panel.dashboard') }}">Dashboard</a></li>
                                <li class="breadcrumb-item" aria-current="page">Data Unit Kerja</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="col-3">
		...
		<section class="datatables">
			<div class="row">
				<div class="col-12">
					<div class="card">
						<div class="card-body">
							<a href="{{ route('admin-panel.work-units.create') }}" class="btn btn-secondary mb-3">Tambah Unit Kerja</a>
										...
										@foreach ($workUnits as $unit)
											<tr>
												...
												<td class="text-center">
													<a href="{{ route('admin-panel.work-units.edit', $unit->id) }} " class="btn btn-sm btn-warning"
                                                        data-toggle="tooltip" data-placement="top" title="Edit">
                                                        <i class="fa fa-pencil-alt"></i>
                                                    </a>
                                                    <form action="{{ route('admin-panel.work-units.destroy', $unit->id) }}" method="POST" class="d-inline swal-confirm">
                                                        @csrf
                                                        @method('DELETE')
...
@push('addon-script')
	...
	$(function () {
		...
		$('.swal-confirm').click(function(event) {
			...
			Swal.fire({
				title: 'Yakin Hapus Unit Kerja?',
				text: "Unit Kerja yang terhapus tidak dapat dikembalikan",
				icon: 'warning',
